    ...
    def _query(self, messages: list[dict[str, str]], **kwargs):
        ...
        try:
            ...
            if response.status_code == 401:
                error_msg = "Authentication failed. You can permanently set your API key with `mtr-extra config set OPENROUTER_API_KEY YOUR_KEY`."
    ...
    def query(self, messages: list[dict[str, str]], **kwargs) -> dict:
        ...
        if cost <= 0.0 and self.config.cost_tracking != "ignore_errors":
            raise RuntimeError(
                ...
                "export MAR_COST_TRACKING='ignore_errors' to ignore cost tracking errors "
