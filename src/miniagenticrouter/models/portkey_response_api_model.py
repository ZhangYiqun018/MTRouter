...
from miniagenticrouter.models.utils.openai_utils import coerce_responses_text
        ...
        try:
            ...
            if self.config.cost_tracking != "ignore_errors":
                raise RuntimeError(
                    ...
                    "globally with export MAR_COST_TRACKING='ignore_errors' to ignore this error. "
                ) from e
            cost = 0.0
        self.n_calls += 1
        self.cost += cost
