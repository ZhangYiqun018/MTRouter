...
_ENVIRONMENT_MAPPING = {
    "docker": "miniagenticrouter.environments.docker.DockerEnvironment",
    "singularity": "miniagenticrouter.environments.singularity.SingularityEnvironment",
    "local": "miniagenticrouter.environments.local.LocalEnvironment",
    "swerex_docker": "miniagenticrouter.environments.extra.swerex_docker.SwerexDockerEnvironment",
    "bubblewrap": "miniagenticrouter.environments.extra.bubblewrap.BubblewrapEnvironment",
}
