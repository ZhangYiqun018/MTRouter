...
from miniagenticrouter.environments.docker import DockerEnvironment
...
DEFAULT_CONFIG = Path(os.getenv("MAR_GITHUB_CONFIG_PATH", builtin_config_dir / "github_issue.yaml"))
