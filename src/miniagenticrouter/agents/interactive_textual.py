...
from miniagenticrouter.agents.default import AgentConfig, DefaultAgent, NonTerminatingException, Submitted
...
class TextualAgent(App):
    ...
    def __init__(self, model, env, **kwargs):
        css_path = os.environ.get("MAR_MINI_STYLE_PATH", str(Path(__file__).parent.parent / "config" / "mini.tcss"))
