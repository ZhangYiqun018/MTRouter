...
from miniagenticrouter.models.portkey_response_api_model import PortkeyResponseAPIModel
...
def test_response_api_model_basic_query():
    ...
    with (
        patch("miniagenticrouter.models.portkey_model.Portkey", mock_portkey_class),
        patch.dict(os.environ, {"PORTKEY_API_KEY": "test-key"}),
        patch(
            "miniagenticrouter.models.portkey_response_api_model.litellm.cost_calculator.completion_cost", return_value=0.01
        ),
    ):
...
def test_response_api_model_cost_tracking():
    ...
    with (
        ...
        patch.dict(os.environ, {"PORTKEY_API_KEY": "test-key"}),
        patch(
            "miniagenticrouter.models.portkey_response_api_model.litellm.cost_calculator.completion_cost", return_value=0.05
        ),
    ):
        mock_response = Mock()
...
def test_response_api_model_zero_cost_assertion():
    ...
    with (
        ...
        patch.dict(os.environ, {"PORTKEY_API_KEY": "test-key"}),
        patch(
            "miniagenticrouter.models.portkey_response_api_model.litellm.cost_calculator.completion_cost", return_value=0.0
        ),
    ):
        mock_response = Mock()
...
def test_response_api_model_cache_control():
    ...
    with (
        ...
        patch("miniagenticrouter.models.portkey_response_api_model.set_cache_control") as mock_cache,
    ):
        mock_response = Mock()
