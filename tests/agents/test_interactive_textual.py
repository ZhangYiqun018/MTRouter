...
from miniagenticrouter.agents.interactive_textual import AddLogEmitCallback, SmartInputContainer, TextualAgent
...
def test_messages_to_steps_edge_cases():
    ...
    from miniagenticrouter.agents.interactive_textual import _messages_to_steps
