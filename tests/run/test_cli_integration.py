...
from miniagenticrouter.run.mini import DEFAULT_CONFIG, app, main
...
def test_configure_if_first_time_called():
    ...
    with (
        patch("miniagenticrouter.run.mini.configure_if_first_time") as mock_configure,
        patch("miniagenticrouter.run.mini.InteractiveAgent") as mock_interactive_agent_class,
        patch("miniagenticrouter.run.mini.get_model") as mock_get_model,
        patch("miniagenticrouter.run.mini.LocalEnvironment") as mock_env,
        patch("miniagenticrouter.run.mini.get_config_path") as mock_get_config_path,
        patch("miniagenticrouter.run.mini.yaml.safe_load") as mock_yaml_load,
    ):
        # Setup mocks
        mock_model = Mock()
...
def test_mini_command_calls_run_interactive():
    ...
    with (
        patch("miniagenticrouter.run.mini.configure_if_first_time"),
        patch("miniagenticrouter.run.mini.InteractiveAgent") as mock_interactive_agent_class,
        patch("miniagenticrouter.run.mini.get_model") as mock_get_model,
        patch("miniagenticrouter.run.mini.LocalEnvironment") as mock_env,
        patch("miniagenticrouter.run.mini.get_config_path") as mock_get_config_path,
...
def test_mini_v_command_calls_run_textual():
    ...
    with (
        patch("miniagenticrouter.run.mini.configure_if_first_time"),
        patch("miniagenticrouter.run.mini.TextualAgent") as mock_textual_agent_class,
        patch("miniagenticrouter.run.mini.get_model") as mock_get_model,
        patch("miniagenticrouter.run.mini.LocalEnvironment") as mock_env,
        patch("miniagenticrouter.run.mini.get_config_path") as mock_get_config_path,
        patch("miniagenticrouter.run.mini.yaml.safe_load") as mock_yaml_load,
...
def test_mini_calls_prompt_when_no_task_provided():
    ...
    with (
        patch("miniagenticrouter.run.mini.configure_if_first_time"),
        patch("miniagenticrouter.run.mini.prompt_session.prompt") as mock_prompt,
        patch("miniagenticrouter.run.mini.InteractiveAgent") as mock_interactive_agent_class,
        patch("miniagenticrouter.run.mini.get_model") as mock_get_model,
        patch("miniagenticrouter.run.mini.LocalEnvironment") as mock_env,
        patch("miniagenticrouter.run.mini.get_config_path") as mock_get_config_path,
...
def test_exit_immediately_flag_with_typer_runner():
    ...
    with (
        ...
        patch("miniagenticrouter.run.mini.get_config_path") as mock_get_config_path,
        patch("miniagenticrouter.run.mini.yaml.safe_load") as mock_yaml_load,
        patch("miniagenticrouter.run.mini.save_traj"),
    ):
        # Setup mocks
        mock_model = Mock()
        mock_get_model.return_value = mock_model
