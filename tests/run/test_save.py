...
def test_save_traj_includes_class_names():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert config["agent_type"] == "miniagenticrouter.agents.default.DefaultAgent"
        assert config["model_type"] == "miniagenticrouter.models.test_models.DeterministicModel"
        assert config["environment_type"] == "miniagenticrouter.environments.local.LocalEnvironment"
